...
<body>
<%
  List<Product> list = new ProductDao().topNewest(9);
  session.setAttribute("listnewspecials",list);
%>
<span style="color: rgb(236, 38, 33);"><b>New Product</b></span> <hr />
<c:choose>
  <c:when test="${not empty listnewspecials}">
    <% int countcontent = 1; %>
    <c:forEach var="product" items="${listnewspecials}">
          ...
          <div class="price">
            ...
            <div  class="cart1">
              ...
              <form action="SearchServlet" method="post">
                ...
                <input type="hidden" name="specialspage" value="5"/>
