...
<body>
<%
  List<Product> list = new ProductDao().top9best();
  session.setAttribute("top9best",list);
%>
<span style="color: rgb(236, 38, 33);"><b>Top 9 Best Seller</b></span> <hr />
<c:choose>
  <c:when test="${not empty top9best}">
    <% int countcontent = 1; %>
    <c:forEach var="product" items="${top9best}">
          ...
          <div class="price">
            ...
            <div  class="cart1">
              ...
              <form action="SearchServlet" method="post">
                ...
                <input type="hidden" name="specialspage" value="2"/>
