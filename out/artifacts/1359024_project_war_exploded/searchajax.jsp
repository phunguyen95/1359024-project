...
<%
  ...
  if(request.getParameter("ver")!=null) {
    List<Product> list = new ProductDao().searchajax(name);
    session.setAttribute("listajax", list);
  }
%>
<c:choose>
  <c:when test="${not empty listajax}">
    <% int countcontent = 1; %>
    <c:forEach var="product" items="${listajax}">
          ...
          <div class="price">
            ...
            <div class="cart1">
              ...
              <form action="SearchServlet" method="post">
                ...
                <input type="hidden" name="specialspage" value="4"/>
